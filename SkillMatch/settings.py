...
SECRET_KEY = 'django-insecure-usilv^etgqpu38h37@a1md2^bjqi2!#t8*)#^^tt82xk6gm3dp'
...
DATABASES = {
    'default': {
        ...
        'PORT': '5432',
        'OPTIONS': {
            'client_encoding': 'UTF8', # Mantén esta opción si estás en Windows.
        },
    }
}
...
EMAIL_HOST_USER = 'noreplyskillmatch@gmail.com'
EMAIL_HOST_PASSWORD = 'vmzd tiqq oogr qxfo'
